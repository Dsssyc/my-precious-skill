...
`case_id` values and empty converted case sets before writing output, but does
not download benchmark data or commit external records to this reusable skill
repository.
