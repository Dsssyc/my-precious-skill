...
class E2EInductionRecallBenchmarkTests(unittest.TestCase):
    ...
    def test_packaged_e2e_cases_produce_aggregate_recall_metrics(self):
        ...
        self.assertEqual(payload["source_records"], 20)
        self.assertEqual(payload["recall_cases"], 10)
        ...
        self.assertEqual(payload["e2e_memory_id_provenance_rate"], 1.0)
    ...
    def test_packaged_e2e_quality_gates_cover_required_metrics(self):
        ...
        self.assertEqual(lower["cases"], 12)
        self.assertEqual(lower["source_records"], 20)
        self.assertEqual(lower["recall_cases"], 10)
        ...
        self.assertEqual(lower["e2e_memory_id_provenance_rate"], 1.0)
