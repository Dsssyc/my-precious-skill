...
class UpdaterInductionBenchmarkTests(unittest.TestCase):
    ...
    def test_packaged_updater_induction_cases_produce_aggregate_metrics(self):
        ...
        self.assertEqual(payload["source_records"], 43)
        self.assertEqual(payload["induction_success_rate"], 1.0)
        self.assertEqual(payload["natural_induction_success_rate"], 1.0)
        self.assertEqual(payload["consolidated_duplicate_suppression_rate"], 1.0)
        self.assertEqual(payload["consolidated_support_merge_rate"], 1.0)
        self.assertEqual(payload["consolidated_evidence_retention_rate"], 1.0)
        self.assertEqual(payload["contradiction_review_routing_rate"], 1.0)
        self.assertEqual(payload["scope_shift_review_routing_rate"], 1.0)
        self.assertEqual(payload["post_consolidation_recall_at_5"], 1.0)
        self.assertEqual(payload["natural_false_promotion_rate"], 0.0)
        self.assertEqual(payload["auto_promotion_precision"], 1.0)
        self.assertEqual(payload["induction_review_routing_rate"], 1.0)
        self.assertEqual(payload["induction_review_decision_apply_rate"], 1.0)
        self.assertEqual(payload["induction_review_approve_promotion_rate"], 1.0)
        self.assertEqual(payload["induction_review_ignore_suppression_rate"], 1.0)
        self.assertEqual(payload["low_confidence_review_rate"], 1.0)
        self.assertEqual(payload["scope_change_review_rate"], 1.0)
        self.assertEqual(payload["conflict_review_rate"], 1.0)
        ...
        self.assertEqual(payload["memory_id_provenance_rate"], 1.0)
        ...
        self.assertEqual(payload["category_counts"]["induction_consolidation"], 1)
        ...
        self.assertEqual(payload["category_counts"]["natural_review_calibration"], 6)
        self.assertEqual(payload["category_counts"]["natural_review_decision"], 3)
    ...
    def test_packaged_updater_induction_quality_gates_cover_required_metrics(self):
        ...
        self.assertEqual(lower["cases"], 30)
        self.assertEqual(lower["source_records"], 43)
        self.assertEqual(lower["induction_success_rate"], 1.0)
        self.assertEqual(lower["natural_induction_success_rate"], 1.0)
        self.assertEqual(lower["consolidated_duplicate_suppression_rate"], 1.0)
        self.assertEqual(lower["consolidated_support_merge_rate"], 1.0)
        self.assertEqual(lower["consolidated_evidence_retention_rate"], 1.0)
        self.assertEqual(lower["contradiction_review_routing_rate"], 1.0)
        self.assertEqual(lower["scope_shift_review_routing_rate"], 1.0)
        self.assertEqual(lower["post_consolidation_recall_at_5"], 1.0)
        self.assertEqual(lower["auto_promotion_precision"], 1.0)
        self.assertEqual(lower["induction_review_routing_rate"], 1.0)
        self.assertEqual(lower["induction_review_decision_apply_rate"], 1.0)
        self.assertEqual(lower["induction_review_approve_promotion_rate"], 1.0)
        self.assertEqual(lower["induction_review_ignore_suppression_rate"], 1.0)
        self.assertEqual(lower["low_confidence_review_rate"], 1.0)
        self.assertEqual(lower["scope_change_review_rate"], 1.0)
        self.assertEqual(lower["conflict_review_rate"], 1.0)
        ...
        self.assertEqual(lower["memory_id_provenance_rate"], 1.0)
